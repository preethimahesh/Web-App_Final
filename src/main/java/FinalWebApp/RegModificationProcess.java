...
public class RegModificationProcess {  
    ...
    public static int save(RegisterDetail pojo){  
        int status=0;  
        try{  
            Connection con=RegModificationProcess.getConnection();  
    ...
    public static int update(RegisterDetail e){  
        int status=0;  
        try{  
            Connection con=RegModificationProcess.getConnection();  
            PreparedStatement ps=con.prepareStatement(  
    ...
    public static RegisterDetail getStudentName(String name){  
        RegisterDetail pojo=new RegisterDetail();  
    ...
    public static List<RegisterDetail> getAllStudent(){  
        List<RegisterDetail> list=new ArrayList<RegisterDetail>();  
