...
public class ViewRegisterDetail extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		response.setContentType("text/html");
		PrintWriter out=response.getWriter();
		out.println("<a href='indexMe.jsp'>Add Student</a>");
		out.println("<h1>Student List</h1>");
		
		List<RegisterDetail> list=RegModificationProcess.getAllStudent();
		
		out.print("<table border='1' width='100%'");
		out.print("<tr><th>Name</th><th>Password</th><th>Email</th><th>PhoneNo</th><th>Place</th><th>Edit</th><th>Delete</th></tr>");
		for(RegisterDetail pojo:list){
